...
pygame.display.set_caption('Flappy Bird Made In Duc Hai Dep Trai')
...
background_img=pygame.image.load('assests/background-night.png')
background_img=pygame.transform.scale(background_img,(400,600))
bird_img=pygame.image.load('assests/bird.png')
bird_img=pygame.transform.scale(bird_img,(35,35))
tube_img=pygame.image.load('assests/pipe-green.png')
tube_op_img=pygame.image.load('assests/pipe-green.png')
sound=pygame.mixer.Sound('sound/hihi.mp3')
sand_img=pygame.image.load('assests/floor.png')
...
while running:
    ...
    tube2_op_img=pygame.transform.scale(tube_op_img,(tube_width,600-(tube1_height+d_2tube)))
    tube2_op=screen.blit(tube2_op_img,(tube2_x,tube2_height+d_2tube)) 
    tube3_op_img=pygame.transform.scale(tube_op_img,(tube_width,600-(tube1_height+d_2tube)))
